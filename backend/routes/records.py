...
def update_record(record_id):
    ...
    for field, attr in [
        ...
        ("controlledConditions", "controlled_conditions"),
        ...
        items.append(
            {
                ...
                "variableType": record_data.get("variableType", ""),
                "variableDescription": record_data.get("variableDescription", ""),
                "controlledConditions": record_data.get("controlledConditions", ""),
                "expectedChange": record_data.get("expectedChange", ""),
